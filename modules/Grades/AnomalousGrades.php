...
if ( empty($_REQUEST['missing']) && empty($_REQUEST['negative']) && empty($_REQUEST['max_allowed']) )
...
if ( isset($_REQUEST['include_all_courses']) && ($_REQUEST['include_all_courses']=='Y') )
{
...
else
{
	...
	$link = array('FULL_NAME' => array('link' => 'Modules.php?modname='.$_REQUEST['modname'].'&include_all_courses='.
	              ( isset($_REQUEST['include_all_courses']) ? $_REQUEST['include_all_courses'] : '' ).'&include_inactive='.
		      ( isset($_REQUEST['include_inactive'])    ? $_REQUEST['include_inactive']    : '' ).'&missing='.
		      ( isset($_REQUEST['missing'])             ? $_REQUEST['missing']            : '' ).'&negative='.
		      ( isset($_REQUEST['negative'])            ? $_REQUEST['negative']            : '' ).'&max_allowed='.
		      ( isset($_REQUEST['max_allowed'])         ? $_REQUEST['max_allowed']         : '' ),'variables' => array('student_id' => 'STUDENT_ID')));
	if ( isset($_REQUEST['include_all_courses']) && ($_REQUEST['include_all_courses']=='Y') )
